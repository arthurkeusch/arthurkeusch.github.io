...
class GetLogLanguageCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
                                        ...
                                        try {
                                            ...
                                            if (is_object($response) && property_exists($response, "error")) {
                                                try {
                                                    ...
                                                    $nbErrors += 1;
                                                    $output->writeln("");
                                                    $output->writeln("<error>Erreur lors de l'enregistrement d'un log d'erreur dans la base de données !</error>");
                                                    $output->writeln("$e");
                                                }
                                            }
                                            try {
                                                ...
                                                $nbErrors += 1;
                                                $output->writeln("");
                                                $output->writeln("<error>Erreur lors de l'enregistrement d'un log dans la base de données !</error>");
                                                $output->writeln("$e");
                                            }
                                        } catch (Exception $e) {
                                            $isError = true;
                                            ...
                                            try {
                                                ...
                                                writeln("<error>Erreur lors de la sauvegarde de l'erreur !</error>");
                                                $output->writeln("$e");
                                            }
                                        }
                                    } catch (Exception $e) {
        ...
        if ($isError) {
            ...
            $output->writeln('<info>Tous les logs ont été récupérés avec succès !</>');
